...
"""
app_db.config ['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///students.sqlite3'
app_db.secret_key = "0256ac1229d70c6056e9ca7d40a014ae4ff730cac62ba81f"
...
@app_db.route('/')
def show_all():
  return render_template('show_all.html', libros = libros.query.all(),  b = "Esto es una expresion")

@app_db.route('/show_all')
def show_all2():
  return render_template('show_all.html', libros = libros.query.all(), b = "Esto es una expresion")
...
@app_db.route('/new', methods=['GET', 'POST'])
def new():
  """
